...
class EmployeeComponent extends Component {
    ...
    render() {
        return (
            <div>
                <div className='card column-mid-6 offset-md=3'>
                    <h3 className='text-center card-header'>Employee Details</h3>
                    <div className='card-body'>
                        <div className='row'>
                            <p><strong>Employee Name: </strong>{this.state.employee.firstName}</p>
                        </div>
                        <div className='row'>
                            <p><strong>Employee Family Name: </strong>{this.state.employee.lastName}</p>
                        </div>
                        <div className='row'>
